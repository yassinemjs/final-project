...
export const Skills = () => {
  ...
  return (
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="mb-1">
          HTML - <small class="text-muted">80%</small>
        </div>
        ...
        <div class="mb-1">
          CSS - <small class="text-muted">95%</small>
        </div>
        <div class="progress mb-3" style={{ height: "4px" }}>
        ...
        <div class="mb-1">
          Javascript - <small class="text-muted">90%</small>
        </div>
        <div class="progress mb-3" style={{ height: "4px" }}>
        ...
        <div class="mb-1">
          UI/UX - <small class="text-muted">80%</small>
        </div>
